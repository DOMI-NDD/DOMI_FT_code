...
abstract final class DomiColor{
  static const Color wrong = Color(0xFFFF7474);
  static const Color warn = Color(0xFFFFDD54);
  static const Color correct = Color(0xFF54FF7F);
  static const Color primary = Color(0xFF454CFF);
  static const Colorsecondary = Color(0xFF6D71FF);
